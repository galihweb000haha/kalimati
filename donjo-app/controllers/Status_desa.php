...
class Status_desa extends Admin_Controller {
	...
	public function index()
	{
		...
		if ($idm->body->error)
		{
			$idm->body->error_msg = $idm->body->message . ' : <a href="' . $idm->header->url . ' ">' . $idm->header->url . '<br><br> Periksa Kode Desa di Identitas Desa. Masukkan kode lengkap, contoh : 3507012006 <br>';
		}
